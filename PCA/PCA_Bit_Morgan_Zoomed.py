...
filtered_data_test = test_data[(test_data['PC1'] >= -20) & (test_data['PC1'] <= 20) &
                         (test_data['PC2'] >= -10) & (test_data['PC2'] <= 10)]

filtered_data_train = train_data[(train_data['PC1'] >= -20) & (train_data['PC1'] <= 20) &
...
plt.title("Bit Morgan PCA Plot: Training vs Testing Sets Zoomed")
plt.legend(loc="upper right")
plt.grid(True)
plt.axis("equal")
plt.savefig('bit_morgan_pca_zoomed.png', dpi=300, bbox_inches='tight')

...
Data_pca = pd.read_csv("https://raw.githubusercontent.com/hattie1298/mini-project-machine-learning-LC/refs/heads/main/mordred_FS_pca.csv")
...
plt.title("Mordred With FS PCA Plot: Training vs Testing Sets")
plt.legend(loc="upper right")
plt.grid(True)
plt.axis("equal")
plt.savefig('mordred_with_FS_pca.png', dpi=300, bbox_inches='tight')
